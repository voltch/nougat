...
if [ "$($BB mount | grep rootfs | cut -c 26-27 | grep -c ro)" -eq "1" ]; then
	...
	FREQ=$(cat /res/synapse/volt/freq);
	FREQ2=$(cat /res/synapse/volt/freq2);
	FREQ3=$(cat /res/synapse/volt/freq3);
	FREQ4=$(cat /res/synapse/volt/freq4);

	chmod 0777 /sys/devices/system/cpu/cpu4/cpufreq/volt_max_freq;
	chmod 0777 /sys/devices/system/cpu/cpu4/cpufreq/volt_min_freq;
	echo $FREQ > /sys/devices/system/cpu/cpu4/cpufreq/volt_max_freq;
	echo $FREQ2 > /sys/devices/system/cpu/cpu4/cpufreq/volt_min_freq;

	chmod 0777 /sys/devices/system/cpu/cpu0/cpufreq/volt_max_freq;
	chmod 0777 /sys/devices/system/cpu/cpu0/cpufreq/volt_min_freq;
	echo $FREQ3 > /sys/devices/system/cpu/cpu0/cpufreq/volt_max_freq;
	echo $FREQ4 > /sys/devices/system/cpu/cpu0/cpufreq/volt_min_freq;
...
CORE1=$(cat /res/synapse/volt/core1);
CORE2=$(cat /res/synapse/volt/core2);
CORE3=$(cat /res/synapse/volt/core3);
CORE5=$(cat /res/synapse/volt/core5);
CORE6=$(cat /res/synapse/volt/core6);
CORE7=$(cat /res/synapse/volt/core7);


chmod 0777 /sys/power/cpuhotplug/enabled;
echo 1 > /sys/power/cpuhotplug/enabled;

	hotplug_screen=$(cat /res/synapse/volt/hotplug);

	if [ "$hotplug_screen" == "0" ]; then
	chmod 0777 /sys/power/cpuhotplug/enabled;
	chmod 0777 /sys/power/cpuhotplug/control_online_cpus;
	chmod 0777 /sys/power/cpuhotplug/max_online_cpu;
	echo 0 > /sys/power/cpuhotplug/enabled;

echo 1 > /sys/devices/system/cpu/cpu0/online;
echo 1 > /sys/devices/system/cpu/cpu4/online;
echo $CORE1 > /sys/devices/system/cpu/cpu1/online;
echo $CORE2 > /sys/devices/system/cpu/cpu2/online;
echo $CORE3 > /sys/devices/system/cpu/cpu3/online;
echo $CORE5 > /sys/devices/system/cpu/cpu5/online;
echo $CORE6 > /sys/devices/system/cpu/cpu6/online;
echo $CORE7 > /sys/devices/system/cpu/cpu7/online;
